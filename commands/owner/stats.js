...
//command
  if(message.author.id != 586802340607164417){
    const noperms = new MessageEmbed()
    .setDescription("<:more_KEKW:838040150352592918>  This Command Only Use By My Owner **MorenT")
    .setColor("YELLOW");
...
.setTitle(`**[Support Server]**`)
  ...
  .addFields(
    ...
    { name: "<a:Owner:822760998938869760> Bot Owner:",value: `\`\`\`MorenT#2000\`\`\``},
  )
  .setColor("3498DB")
  .setFooter("Thx For Choosing Salbot!")  
